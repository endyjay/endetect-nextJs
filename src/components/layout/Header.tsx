...
const Header = () => {
  ...
  return (
    <div className="min-h-[124px]">
      <header
        className={`fixed top-0 left-0 w-full z-50 transition-transform duration-300 bg-white shadow-lg ${showHeader ? "translate-y-0" : "-translate-y-full"
          }`}
        ...
        <div className="ast-above-header-wrap bg-gray-50 border-b border-gray-200">
          ...
          <div className=" py-[16px]  bg-white">
            <div className=" w-full container  flex justify-between items-center">
              ...
              >
                <span
                  className={`block w-7 h-0.5 bg-[#24C16F] mb-1 transition-all duration-300 ${mobileMenuOpen ? "rotate-45 translate-y-2" : ""
                    }`}
                ></span>
                <span
                  className={`block w-7 h-0.5 bg-[#24C16F] mb-1 transition-all duration-300 ${mobileMenuOpen ? "opacity-0" : ""
                    }`}
                ></span>
                <span
                  className={`block w-7 h-0.5 bg-[#24C16F] transition-all duration-300 ${mobileMenuOpen ? "-rotate-45 -translate-y-2" : ""
                    }`}
                ></span>
              </button>
            </div>
