    ...
    <div className='pricing-policy min-h-[100vh] bg-[#F6F6F8] py-[10px]'>
      <div className='container'>
        <div className='pb-[23px]'>
          <h1 className='text-center uppercase font-[600]!'>Refund & CANCELLATION Policy</h1>
        ...
        <div className="elementor-widget-container">
          ...
          <p>
            Customer Support
            <br />
            If you have any queries, do call our help desk at <strong>+91</strong> <strong>97112 86969</strong> or email us at <strong>support@endetect.com</strong>.
          </p>
        </div>
      </div>
    </div>
